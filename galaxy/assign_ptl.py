...
w.create_dataset("blue_ptl",data=blue_ptls, compression="gzip", compression_opts=9)
w.create_dataset("red_ptl", data=red_ptls, compression="gzip", compression_opts=9)
w.close()